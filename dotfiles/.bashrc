...
alias pqgc='psh "git commit -m 'update'"'
alias ..='cd ..'
alias ...='cd ../..'
alias ....='cd ../../..'
...
alias gimme-aws-creds='p "C:\Users/erohman/AppData/Local/Programs/Python/Python313/Scripts/gimme-aws-creds"'
alias bible='vim ~/kjv.txt'
...
tmuxwork() {
  ...
  tmux rename-window -t work:1 proc
  tmux new-window -t work
  tmux rename-window -t work:2 edit
  tmux new-window -t work
...
export PATH="$PATH:/mnt/c/Progra Files/Java/jdk-21/bin"
